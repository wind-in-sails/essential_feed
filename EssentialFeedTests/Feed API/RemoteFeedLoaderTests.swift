...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_doesNotDeliveresultsAfterSUTInctanceHasBeenDeallocated() {
    ...
    // MARK: - Helpers
    private func trackForMemoryLeaks(_ instance: AnyObject, _ file: StaticString, _ line: UInt) {
